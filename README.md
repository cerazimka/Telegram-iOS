...
- Telegram chat: https://t.me/exteragramchat
- TestFlight beta, local chats, translations and other [@ExteraGramLinks](https://t.me/s/ExteraGramLinks)

ExteraGram's compilation steps are the same as for the official app. Below you'll find a complete compilation guide based on the official app.
...
```
git clone --recursive -j8 https://github.com/ExteraGram/Telegram-iOS.git
```
...
openssl rand -hex 8
```
2. Create a new Xcode project. Use `ExteraGram` as the Product Name. Use `org.{identifier from step 1}` as the Organization Identifier.
